...
ngSlideDownDirective.$inject = ['$timeout']
export function ngSlideDownDirective($timeout: ng.ITimeoutService): ng.IDirective {
    return {
        restrict: 'A',
...
var ngSlideDownModule = angular.module('ng-slide-down', []);
ngSlideDownModule.directive('ngSlideDown', ngSlideDownDirective);
